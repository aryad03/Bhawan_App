...
class RegistrationPageAdmin extends StatefulWidget {

  final void Function(int) toggle;
  RegistrationPageAdmin({required this.toggle});

  @override
  State<RegistrationPageAdmin> createState() => _RegistrationPageAdminState();
}

class _RegistrationPageAdminState extends State<RegistrationPageAdmin> {
